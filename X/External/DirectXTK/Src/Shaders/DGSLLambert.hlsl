...
//
// This file was generated by exporting HLSL from Visual Studio's default "Lambert" Light, and then modified to handle both texture scenarios, multiple Lights, and work with FL 9.x
...
P2F main(V2P pixel)
{
    ...
    float3 local3 = LightAmbient.rgb * AmbientLight.rgb;
    [unroll]
    for (int i = 0; i < 4; i++)
    {
